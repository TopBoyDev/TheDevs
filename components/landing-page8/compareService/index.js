                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="heading-title white">
                                    <h3 className="title iq-tw-7">Compare Services</h3>
                                    <p className="iq-font-white">Comparison of services as per the features and services provided.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
