...
import {CardStyle6, SectionTitle} from '../../sofbox';
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12">
                                <SectionTitle
                                    title="sofbox Specialities"
                                    subTitle="sofbox is popular for the below specialities that can make your website look beautiful"
                                />
                            </div>
                        </div>
                        <div className="row">
