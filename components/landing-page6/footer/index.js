                ...
                <FooterMain className={"iq-footerr iq-pt-40 iq-pb-20"}>
                    ...
                    <div className="row iq-mt-20 align-items-center">
                        <div className="col-auto mr-auto">
                            <ul className="link">
                                <li className="d-inline-block img-fluid"><img className="img-fluid logo_img" id="logo_img" src="/assets/images/color-customizer/color-1.png" alt="#" /></li>
                                <li className="d-inline-block iq-mr-10"><a href="#">Term and Condition</a></li>
                                <li className="d-inline-block"><a href="#"> Privacy Policy</a></li>
                            </ul>
                        </div>
                        <div className="col-auto">
                            <div className="iq-copyright iq-ml-10">
                                © 2022<a href="#">The Developers</a> All Rights Reserved
                            </div>
                        </div>
                    </div>
                </FooterMain>
